...
class SensorComponent:
    ...
    def get_prev_processed_data(self):
        return self.processed_data
    
    def get_new_processed_data(self):
    ...
    def get_metrics(self):
        if self.is_buffer_updated() and self.sensor_status:
            metrics_dict = {
                'id': self.sensor_id,
                'component': self.component_id,
                'value': self.get_new_processed_data(),
                'alert': self.is_safe()
            }
        else:
            metrics_dict = {}
...
if __name__ == '__main__':
    ...
    print(f'Processed data buffer: {co_sensor.get_new_processed_data()}')
    print(f'Processed data buffer: {co_sensor.get_new_processed_data()}')
